...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _fetchData.fetchLabUsersList();
    _fetchData.fetchMyBookingList();
      ...
      builder: (context, snapshot) {
        ...
        return snapshot.data == null
            ...
            : ListView.builder(
                ...
                itemCount: labs == null ? 0 : labs.length,
                itemBuilder: (context, index) {
                  return Laboratory(context, labs[index].name,
                      labs[index].location, labs[index].phoneNumber);
                });
      },
    );
  }
  ...
  //               scrollDirection: Axis.horizontal,
  //               // physics: NeverScrollableScrollPhysics(),
  //               itemCount: bookings == null ? 0 : bookings.length,
  //               itemBuilder: (context, index) {
  //                 return Laboratory(context, bookings[index].[index].location, labs[index].phoneNumber);
  //               });
  //     },
  //   );
  // }
