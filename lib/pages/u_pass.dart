...
import 'package:grad_project/pages/u_setting.dart';
...
class _u_passwordState extends State<u_password> {
  ...
  Future<void> editPassword() async {
    ...
    var res = await http.post(
      Uri.parse(fetchData.baseURL + "/users/password"),
      headers: {
    ...
    if (res.statusCode == 200) {
      ...
      print(body1);
      var res1 = await http.patch(Uri.parse(fetchData.baseURL + "/users/me"),
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            "Authorization": "Bearer " + prefs.get("token").toString()
          },
